 ...
 */
public class Escarola implements Pizza{
    
    @Override
    public void montar() {
        System.out.println("Pizza de Escarola");
        System.out.println("Molho de tomate, ecarola refogada, muçarela, alho frito e azeitona preta");
    }
